...
![The Infrastructure board, full story: SAN LUNs with multipath, hosts with live CPU/memory/NIC load, and the GPU inventory of a GPU supervisor](/images/platform-health/infrastructure-board.png)
