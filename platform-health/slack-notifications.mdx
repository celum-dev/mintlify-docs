...
<Steps>
  ...
  <Step title="Enable interactivity">
    Under **Interactivity & Shortcuts**, turn interactivity **On** and set the Request URL to `https://<your-api-host>/api/slack/interactions`. Copy the **Signing Secret** from **Basic Information**.
  </Step>
